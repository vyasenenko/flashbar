...
class Flashbar private constructor(private var builder: Builder) {
    ...
    class Builder(internal var activity: Activity) {
        ...
        /**
         * Specifies if modal overlay is block and should consume touch events
         */
         ...
         */
        @JvmOverloads
        fun showIcon(scale: Float = DEFAULT_ICON_SCALE, scaleType: ScaleType = CENTER_CROP) =
            apply {
    ...
    enum class DismissEvent {
        TIMEOUT, MANUAL, TAP_OUTSIDE, SWIPE
    }
