...
import com.yasenenko.tool.databinding.ActivityMainBinding
...
class SampleActivity : AppCompatActivity() {
    ...
    private fun titleAdvanced(): Flashbar {
        return Flashbar.Builder(this)
                .gravity(Flashbar.Gravity.BOTTOM)
                .title("Hello World")
                .titleColorRes(com.yasenenko.flashbar.R.color.white)
                .titleSizeInSp(28f)
    ...
    private fun messageAdvanced(): Flashbar {
        return Flashbar.Builder(this)
                ...
                .messageColor(ContextCompat.getColor(this, com.yasenenko.flashbar.R.color.white))
                .messageSizeInSp(16f)
